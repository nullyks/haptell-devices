...
const HTTP_HOST = process.env.HAPTELL_05_WEB_HOST || "127.0.0.1";
const HTTP_PORT = Number(process.env.HAPTELL_05_WEB_PORT || 8084);
...
server.listen(HTTP_PORT, HTTP_HOST, () => {
  console.log(`Haptell 05 Servo Shape Designer running at http://${HTTP_HOST}:${HTTP_PORT}`);
