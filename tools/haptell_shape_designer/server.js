...
const HTTP_HOST = process.env.HAPTELL_SHAPE_WEB_HOST || "127.0.0.1";
const HTTP_PORT = Number(process.env.HAPTELL_SHAPE_WEB_PORT || 8082);
...
server.listen(HTTP_PORT, HTTP_HOST, () => {
  console.log(`Haptell Shape Designer running at http://${HTTP_HOST}:${HTTP_PORT}`);
