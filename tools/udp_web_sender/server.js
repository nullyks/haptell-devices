...
const HTTP_HOST = process.env.HAPTELL_WEB_HOST || "127.0.0.1";
const HTTP_PORT = Number(process.env.HAPTELL_WEB_PORT || 8080);
...
server.listen(HTTP_PORT, HTTP_HOST, () => {
  console.log(`Haptell UDP web sender running at http://${HTTP_HOST}:${HTTP_PORT}`);
